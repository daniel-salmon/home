...
cd ~/src/github.com/daniel-salmon/home
...
curl -0 --output ~/Downloads/go1.18.1.linux-amd64.tar.gz https://dl.google.com/go/go1.18.1.linux-amd64.tar.gz
sudo tar -C /usr/local -xzf ~/Downloads/go1.18.1.linux-amd64.tar.gz
echo 'export PATH=$PATH:/usr/local/go/bin' >> ~/.bashrc
rm -rf ~/Downloads/go1.18.1.linux-amd64.tar.gz
...
sudo apt-get --yes install postgresql-14
